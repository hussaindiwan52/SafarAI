...
async def execute(request):
    ...
    prompt = (
        ...
        f"with a budget of {request['budget']}INR and type of travel: {request['type_of_travel']}. Suggest 2-3 activities, each with name, description, price estimate, and duration. "
        f"Respond with a list of activities."
    )
